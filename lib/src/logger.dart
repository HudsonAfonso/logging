...
class Logger {
  ...
  void log(
    ...
    if (isLoggable(logLevel)) {
      ...
      if (stackTrace == null && logLevel >= recordStackTraceAtLevel) {
        ...
        error ??= 'autogenerated stack trace for $logLevel $message';
      }
      zone ??= Zone.current;

      var record = LogRecord(logLevel, message, fullName, error, stackTrace, zone, object, duration);
  ...
  void finest(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.FINEST, message, object, error, stackTrace, duration);
  ...
  void finer(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.FINER, message, object, error, stackTrace, duration);
  ...
  void fine(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.FINE, message, object, error, stackTrace, duration);
  ...
  void config(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.CONFIG, message, object, error, stackTrace, duration);
  ...
  void info(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.INFO, message, object, error, stackTrace, duration);
  ...
  void warning(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.WARNING, message, object, error, stackTrace, duration);
  ...
  void severe(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.SEVERE, message, object, error, stackTrace, duration);
  ...
  void shout(
    ...
    StackTrace? stackTrace,
      ...
      log(Level.SHOUT, message, object, error, stackTrace, duration);
